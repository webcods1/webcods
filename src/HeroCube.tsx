...
const HeroCube: React.FC = () => {
    ...
    const faceBaseClass = "absolute inset-0 bg-white/80 border border-blue-200/50 backdrop-blur-sm flex items-center justify-center transition-all duration-700 ease-in-out backface-hidden";
    const faceTrans = (isOpen: boolean) => isOpen ? 'opacity-0' : 'opacity-80 hover:opacity-100';

    return (
        <div className="hidden lg:block relative w-24 h-24 perspective-1000 mt-16 mx-auto z-40">
            <div
            ...
            >
                ...
                >
                    <div className="w-8 h-8 rounded-full bg-blue-500/20 blur-md"></div>
                </div>
                ...
                <div className={`
                    ...
                    border border-blue-100 shadow-[0_0_40px_rgba(59,130,246,0.3)] 
                ...
                `}>
                    <div className="w-16 h-16 rounded-full overflow-hidden mb-3 border-2 border-blue-100 shadow-sm">
                        <img
                            src="/mill.jpeg"
                            alt="WIP"
                    ...
                    <div className="text-[10px] font-bold text-blue-500 uppercase tracking-widest mb-1 bg-blue-50 px-2 py-0.5 rounded-full">
                        Work in Progress
                    </div>
            ...
            <div className={`
                absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 
                w-20 h-20 bg-blue-400/20 blur-xl rounded-full -z-10
